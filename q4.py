...
def process_image(img_path, output_dir, params):
    ...
    st_corners_overlay = draw_pixels_on_image(orig_u8, st_binary, color_rgb=[0, 0, 0])          # Black corners
    harris_edges_overlay = draw_pixels_on_image(orig_u8, edge_binary, color_rgb=[255, 255, 255])  # White edges

    iio.imwrite(os.path.join(output_dir, f"{base_name}_1_input.png"), orig_u8)
